...
export const STRINGS: Record<string, string> = {
  ...
  stage2_mission1_intro:    'משימה ראשונה: הרווח 25 מטבעות 🪙',
  ...
  stage2_mission2_intro:    'משימה: הפקד 50 מטבעות בפיקדון הבנקאי 🏛️',
  ...
  stage2_mission3_intro_target: 'הרוויח עוד 150 מטבעות',
  ...
  stage3_mission1_intro:     'משימה ראשונה: השלם 4 הזמנות בלוח העבודה',
  stage3_mission1_tagline:   'עכשיו תראה את הוראת הקבע עובדת',
  stage3_mission1_intro_btn: 'עבור לעבודה',
  stage3_mission1_complete:  'המשימה הושלמה! חזית את הפיצול עובד 4 פעמים. החיסכון נכנס לבד.',
  ...
  stage3_mission2_intro:     'משימה: השלם עוד 5 הזמנות',
  ...
  stage3_mission3_intro:     'משימה: השלם עוד 6 הזמנות',
  ...
  // Mission 1 — earn 100 coins
  stage4_mission1_intro:    'משימה ראשונה: הרווח 100 מטבעות להשקעה 🪙',
  ...
  stage4_mission2_intro:    'משימה: השקע 50 מטבעות ב-S&P 500 📈',
  ...
  // Mission 1
  stage5_mission1_intro:     'משימה ראשונה: הרווח 120 מטבעות 🪙',
