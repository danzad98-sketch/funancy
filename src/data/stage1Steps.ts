...
export const STAGE2_MISSION1_TARGET = 250;  // coins to earn (mission 1) — eased from 300
export const STAGE2_MISSION1_REWARD = 2;    // +2 time boosters
export const STAGE2_MISSION2_TARGET = 200;  // coins to deposit (lesson number — kept)
export const STAGE2_MISSION2_REWARD = 1;    // +1 time booster
export const STAGE2_MISSION3_TARGET = 200;  // additional coins to earn — eased from 250
